  ...
  "commonInfo": {
    ...
    "theme": {
        ...
        "accent": [
          {
            ...
            "namePretty": "Accent primary",
            "raw": "#f16465",
            "hex": "#f16465",
            "rgba": "rgba(241, 100, 101, 1)"
          },
          {
            "name": "--color-accent-secondary",
            "namePretty": "Accent secondary",
            "raw": "#f88",
            "hex": "#f88",
            "rgba": "rgba(255, 136, 136, 1)"
          }
        ]
      },
      "fonts": {
        "primary": {
          "name": "--font-primary",
          "namePretty": "Courier New",
          "raw": "\"Courier New\", courier, monospace",
          "weights": {
            "normal": {
              "weight": "normal",
              "hasNormal": true,
        ...
        "secondary": {
          "name": "--font-secondary",
          "namePretty": "Gloria Hallelujah",
          "raw": "\"Gloria Hallelujah\", sans-serif",
          "weights": {
            "normal": {
              "weight": "normal",
              "hasNormal": true,
      ...
      "coloursRaw": {
        ...
        "--color-accent-primary": "#f16465",
        "--color-accent-secondary": "#f88",
        "--color-neutral": "#e2e2e2"
      },
      "fontsRaw": {
        "--font-primary": "\"Courier New\", courier, monospace",
        "--font-secondary": "\"Gloria Hallelujah\", sans-serif"
      }
    },
    "readme": {
      "attributes": {
      ...
      "bodyBasic": "bagelboi brings custom clothing designs that are both green and ethical to your doorstep through it's online store."
    },
    "icons": [
      "icons"
    ],
